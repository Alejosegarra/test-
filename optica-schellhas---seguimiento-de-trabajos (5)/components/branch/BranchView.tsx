...
import { JobStatus, JobPriority, type User, type Job, type BranchViewTab } from '../../types';
import * as api from '../../services/api';
import { supabase } from '../../services/supabaseClient';
import JobCard from '../JobCard';
import { Button, Input, Card, CardHeader, CardContent, Checkbox } from '../common/UI';
import { PlusIcon, SendIcon, BriefcaseIcon } from '../common/Icons';
...
const BranchView: React.FC<{ user: User }> = ({ user }) => {
    ...
    const fetchJobs = useCallback(async () => {
        ...
        setJobs(jobs);
        setTotalJobs(count);
    }, [user, currentPage, filters, sortBy, activeTab]);
    ...
    }, [jobNumber, description, user, addToast, fetchJobs, branchPrefix, currentPage, activeTab]);
    ...
    const handleBulkSendToLab = useCallback(async () => {
        ...
        setSelectedJobIds([]);
        fetchJobs();
    }, [selectedJobIds, user, addToast, fetchJobs]);
