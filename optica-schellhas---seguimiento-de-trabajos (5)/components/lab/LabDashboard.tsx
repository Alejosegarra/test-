...
interface LabDashboardProps {
    ...
    onOverdueJobClick: (job: Job) => void;
}

const LabDashboard: React.FC<LabDashboardProps> = ({ stats, overdueJobs, onNavigateToList, onOverdueJobClick }) => {
    return (
        <div>
