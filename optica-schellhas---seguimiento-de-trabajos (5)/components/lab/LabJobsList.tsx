...
import { Button, Input, Select, Checkbox, Card, CardHeader, CardContent, DateInput } from '../common/UI';
...
const LabJobsList: React.FC<LabJobsListProps> = ({ user, tabCounts, onBack, onDataUpdate, focusJobId, overdueJobs }) => {
    ...
    const handleOverdueWarningClick = (job: Job) => {
        setActiveTab(JobStatus.SentToLab);
    ...
    return (
        <div>
            ...
            <OverdueJobsWarning
                jobs={overdueJobs}
                title="¡Atención! Trabajos demorados para recepción"
                description="Los siguientes trabajos fueron enviados por las sucursales hace más de 48hs hábiles y aún no han sido marcados como recibidos."
                onJobClick={handleOverdueWarningClick}
            />
