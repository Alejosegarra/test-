...
import { AlertTriangleIcon, BranchIcon, CheckCircleIcon, SendIcon, TruckIcon, CheckIcon, RepeatIcon, ChevronRightIcon } from './Icons';
        ...
        <>
            ...
            {isExpanded && (
                <tr className="md:hidden border-b dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50" id={`details-${job.id}`}>
                    <td colSpan={user.role === Role.Lab ? 8 : 7} className="p-4">
