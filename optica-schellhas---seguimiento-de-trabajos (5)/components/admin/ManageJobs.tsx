...
import { BriefcaseIcon, PlusIcon, EditIcon, TrashIcon, HistoryIcon, DownloadIcon, ChevronRightIcon } from '../common/Icons';
...
type ExportableJobKeys = 'id' | 'description' | 'branch_name' | 'status' | 'priority' | 'priority_message' | 'created_at' | 'updated_at' | 'history';
...
const ManageJobs: React.FC<{ user: User }> = ({ user }) => {
    ...
    }, [user, addToast, currentPage, searchTerm, filters, sortBy]);
