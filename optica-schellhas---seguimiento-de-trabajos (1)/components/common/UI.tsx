...
export const StatCard: React.FC<{icon: React.ReactElement<{ className?: string }>, title: string, value: string | number, color?: string, isLoading?: boolean}> = ({icon, title, value, color='text-blue-600', isLoading}) => (
    <Card>
        <CardContent className="flex items-center">
            ...
            <div>
                ...
                {isLoading ? (
                     <div className="h-9 w-24 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mt-1"></div>
                ) : (
