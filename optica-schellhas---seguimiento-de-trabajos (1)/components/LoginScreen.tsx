    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-slate-900">
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 dark:text-slate-100 mt-2">Optica Schellhas</h1>
          <p className="text-gray-600 dark:text-slate-400">Sistema de Seguimiento de Trabajos</p>
        </div>
        <Card className="shadow-2xl">
          <CardHeader>
            <h2 className="text-2xl font-bold text-center text-gray-700 dark:text-slate-200">Iniciar Sesión</h2>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-slate-300" htmlFor="username-select">
                  Usuario
                </label>
                <Select
                  id="username-select"
